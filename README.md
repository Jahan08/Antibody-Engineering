...
#### Types of Antibodies
1. Monoclonal: Are laboratory-produced by B cells and specifically target antigens. to serve as substitute antibodies that can restore, enhance, modify or mimic the immune system's attack on cells that aren't wanted, such as cancer cells.Monoclonal antibodies (mAbs) that target the SARS-CoV-2 spike protein have been shown to have clinical benefits in treating SARS-CoV-2 infection. "The big problem is that monoclonal antibodies bind to a very small piece of the virus. As the virus changes, we are now in a position in which we lost them all because they don't bind to the virus anymore," Johns Hopkins School of Medicine professor Arturo Casadevall, MD, PhD, told NBC News
